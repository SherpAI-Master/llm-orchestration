...
# Load your data
df = pd.read_json("llm-orchestration/data/detect_misplaced.jsonl", lines=True)
...
print(df.head())
df.to_json("llm-orchestration/data/detect_misplaced_ft.jsonl", lines=True, orient="records")
